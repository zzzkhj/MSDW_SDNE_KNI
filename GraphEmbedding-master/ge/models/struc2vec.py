...
class Struc2Vec():
    def __init__(self, graph, walk_length=80, num_walks=10, workers=1, verbose=0, stay_prob=0.3, opt1_reduce_len=True,
    ...
    def train(self, embed_size=64, window_size=4, workers=3, iter=5):
        ...
        model = Word2Vec(sentences, size=embed_size, window=window_size, min_count=0, hs=1, sg=1, workers=workers, iter =iter)
